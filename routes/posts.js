    ...
    if (currentPost.User != loggeduserobj.username) {
      Post.findByIdAndUpdate(
        ...
        function (err, data) {
          ...
          res.send({ message: req.params.postId + " Post has been liked successfully" });
        }
      );
    } else {
    ...
    if (currentPost.User != loggeduserobj.username) {
      Post.findByIdAndUpdate(
        ...
        function (err, data) {
          ...
          res.send({ message: currentPost._id + " Your comment was posted successfully" });
        }
      );
    } else {
      res.send({ message: "You can't comment on your own post" });
    }
  });
